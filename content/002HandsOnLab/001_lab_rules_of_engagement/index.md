...
{{% notice %}}:bulb: When first created, all policy groups and configurations default to "All entities" in scope. Make sure to change the scope to your label ONLY! Failure to do so will impact other attendees' ability to test their configurations.<br><br> {{< figure src="lab_rules_1.jpg" alt="lab_rules_1" >}}{{% /notice %}} ![lab_rules_1.jpg](lab_rules_1.jpg)
