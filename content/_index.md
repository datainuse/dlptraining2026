---
title: "Data Protection including Insider Risk Management, SaaS Data Protection and Data Loss Prevention with FortiDLP"
weight: 1
archetype: "home"
---
...
### Overview: securing data from insider threats, risks and malicious outsiders
...
Through Secure Data Flow, FortiDLP can also automatically identify, and track data based on its origin, such as OneDrive, Workday or a source code repository. DLP and insider risk policies can be enforced based on where the data originated from and whether a corporate or non-corporate account was used to egress data.
